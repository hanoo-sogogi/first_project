...
def create_parser():
    ...
    parser.add_argument("--unique_name", type=str, default="model", help="Unique name under which the model will be stored (checkpoint_<unique_name>.tar).")
    ...
    parser.add_argument("--avg_tps", action='store_true', help="Keep the unique_name as-is during inference instead of deriving it from argv (upstream inference.py reads this flag but never defines it).")
